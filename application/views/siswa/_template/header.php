<head>
    ...
    <script text="text/javascript" src="<?php echo base_url('assets/js/jquery.js') ?>"></script>
    <script text="text/javascript" src="<?php echo base_url('assets/js/script.js') ?>"></script>
