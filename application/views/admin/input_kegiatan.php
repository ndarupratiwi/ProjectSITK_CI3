<div class="pendaftaran bg-white">
    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-1 my-5">
            <form method="POST" action="<?php echo base_url('Admin/input_kegiatan'); ?>" class="formpendaftaran" enctype="multipart/form-data">
                ...
                <div class="buttom col-sm-12 my-5">
                    <div class="kelompok mt-5 text-center my-3">
                        ...
                        <a href="<?php echo base_url('admin/kegiatan_tk'); ?>" class="btn btn-info">Kembali</a>
                    </div>
                </div>
            </form>
        </div>
