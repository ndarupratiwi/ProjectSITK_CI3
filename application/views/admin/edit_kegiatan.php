<div class=" bg-white">
    ...
    <div class="row">
        <div class="col-sm-10 offset-sm-1 my-5">
            ...
            <?php
            foreach ($editkegiatan as $row) {
            ?>
                <form action="<?php echo base_url('admin/update_kegiatan'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <img src="<?php echo base_url('uploads/foto_kegiatan/'); ?><?php echo $row->foto; ?>" width="200" height="250" alt="">
